...
8. [x] Предоставьте возможность как можно скорее закрыть доступ сотрудникам, если это необходимо.
9. [ ] У клиентов есть идентификатор, полный адрес, телефон, адрес электронной почты и заметки.
10. [ ] Заявки имеют идентификатор, название, примечания, даты создания и обновления.
11. [ ] Заявки либо ОТКРЫТЫ, либо ЗАВЕРШЕНЫ.
12. [ ] Заявки назначаются конкретным сотрудникам
