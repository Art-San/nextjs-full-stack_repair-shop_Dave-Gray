...
export const saveCustomerAction = actionClient
  ...
  .action(
    async ({
      ...
      // New Customer
      // Все новые клиенты активны по умолчанию — нет необходимости устанавливать для параметра active значение true
      // CreateAt и UpdateAt устанавливаются базой данных
      if (customer.id === 0) {
